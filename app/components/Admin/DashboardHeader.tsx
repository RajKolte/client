...
const DashboardHeader: FC<Props> = ({ open, setOpen }) => {
  return (
    <div className="w-full flex items-center justify-end p-6 fixed top-5 right-0">
      ...
      {open && (
        <div className="w-[350px] h-[50vh] dark:bg-[#111cc43] bg-white shadow-xl absolute top-16 z-10 rounded">
          ...
          <div className="dark:bg-[#2d3a4ea1] bg-[#00000013] font-Poppins border-b dark:border-b-[#ffffff47] border-b-[#0000000f]">
            ...
            <p className="px-2 text-black dark:text-white">
              ...
              elit.Deserunt,sequi! Tempore libero omnis et, ea beatae ut, itaque
            </p>
