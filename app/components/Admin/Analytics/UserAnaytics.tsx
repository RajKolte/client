...
const UserAnaytics = ({ isDashboard }: Props) => {
  ...
  data && data.users.last12Months.forEach((item:any) => {
    analyticsData.push({name: item.month, count:
  });
  ...
  return (
    <>
      {isLoading ? (
        ...
        >
          <div className={`${isDashboard ? "Iml-8 mb-5" : ""}`}>
            <h1
